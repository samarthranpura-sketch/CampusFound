...
if (isset($_GET["delete"])) {
    ...
    $stmt = mysqli_prepare($conn, "DELETE FROM found_items WHERE id = ?");
...
<head>
    ...
    <title>Manage Found Items - CampusFound</title>
                    ...
                    <?php if ($result && mysqli_num_rows($result) > 0): ?>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo htmlspecialchars($row["date_found"]); ?>
                                </td>
    ...
    <script>
        function deleteItem(id) {
            ...
            if (confirm("Are you sure you want to delete this found item?")) {
                ...
                window.location.href = "found-items.php?delete=" + id;
